...
/* Add this code any theme in your function file*/
...
wp_enqueue_style( 'style.css-n', get_stylesheet_directory_uri() . '/assets/css/style.css',array());
wp_enqueue_style( 'custom.scss-n', get_stylesheet_directory_uri() . '/custom.scss',array());
